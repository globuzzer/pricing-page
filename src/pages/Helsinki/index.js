...
import services from "../../mockData/mockHelsinkiServices";
import {GetWindowDimension} from "../../utils/GetWindowDimension";
import mockHelsinkiTopic from "../../mockData/mockHelsinkiTopic";
import "./style.css";
        ...
        <>
            <section className="helsinki_header">
                ...
                <p id="header_suggestion">
                    Maybe <a href="./AboutUs.js">Stockholm</a>, <Link to="./helsinki">Helsinki</Link> or
                        ...
                        <>
                            {sorted.map((service, index) => (
                                <div className="single_service_container">
                                    <img alt="service" key={index} src={service.icon} className="single_service_icon" />
            ...
            <section className="helsinki_topics">
                ...
                {mockHelsinkiTopic.map((topic, index) => (
                    <div key={index}>
