...
export const PricingPlanChoose = (props) => {
    ...
    const styles = {
        ...
        handle: {borderBottom: width >= 1100 ? `34px solid${cHandle}` : `21.14px solid${cHandle}`},
        get: {background: cGet},
    };
    return (
        <div className="choose_pricing_card_container">
            ...
            <div className="choose_pricing_plan_feature">
                ...
                <p style={{fontWeight: copywritingBold && "bold"}}>Globuzzer account</p>
            </div>
            <div className="choose_pricing_plan_feature">
                {guidelines ? (
                    <AiOutlineCheck className="choose_pricing_card_feature_icon choose_pricing_checked" />
            ...
            <div className="choose_pricing_plan_feature">
                ...
                <p style={{fontWeight: keywordBold && "bold"}}>SEO optimised article</p>
            </div>
            <div className="choose_pricing_plan_feature">
                {positioning ? (
                    <AiOutlineCheck className="choose_pricing_card_feature_icon choose_pricing_checked" />
                ...
                <p style={{fontWeight: positioningBold && "bold"}}>Positioning in newsletter</p>
            </div>
            <div className="choose_pricing_plan_feature">
                {SEO ? (
                    <AiOutlineCheck className="choose_pricing_card_feature_icon choose_pricing_checked" />
            ...
            {/* <button type="button" className="choose_pricing_card_get" style={styles.get}>
                Get
            </button> */}
            ...
            <div id="choose_pricing_card_banner" style={styles.banner}>
                {isFree ? (
                    ...
                    <p id="choose_pricing_price">
                        Starting from <br /> <span id="choose_pricing_bold">€ {price}</span> / month
                    </p>
                )}
            </div>
