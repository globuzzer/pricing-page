    ...
    return (
        <div className="container">
            ...
            <div
                ...
                style={{gridTemplateColumns: joinCity.length === 1 && joinCity[0].name === query && "185px"}}
            >
                ...
                {joinCity.length !== 0 && joinCity[0].name !== query && query.length !== 0 && (
                    <RequestNewCity
            ...
            <button
                ...
                onClick={() => {
                    selected !== undefined ? navigateTo(navlink) : alert("Please select a city");
                }}
            >
                Explore
            </button>
