...
import {FaPlayCircle, FaLinkedinIn, FaInstagram, FaFacebookF, FaTwitter, FaPinterestP} from "react-icons/fa";
...
export const Footer = () => {
        ...
        <footer id="main_footer">
            ...
            <div className="footer-content">
                <div className="footer-content-column">
                    ...
                    <a href="mailto:info@globuzzer.com" target="_blank" rel="noopener noreferrer">
                        info@globuzzer.com
                    </a>
                </div>
                <div className="footer-content-column">
                    <a href="/#section_newcity">Destination</a>
                    {/* <a href="../../pages/Home.js">Videos</a> */}
                    <a href="/#featured_articles">Articles</a>
                    <a href="/#aux_services">Services</a>
                    <div id="buffer" />
                    {/* <div style={{color: "white"}}>
                        <a href="https://globuzzer.mn.co/sign_in">Log in</a> / <a href="/signup">Sign Up </a>
                    </div> */}
                </div>
                <div className="footer-content-column">
                    ...
                    {/* <a href="/#section_headers">For companies</a> */}
                </div>
                <div className="footer-content-column">
                    ...
                    <div className="footer-content-icon-container">
                        <a className="footer_icons_container" href="https://www.facebook.com/Globuzzer/">
                            <FaFacebookF className="footer_icons" />
                        </a>
                        <a className="footer_icons_container" href="https://twitter.com/globuzzer">
                            <FaTwitter className="footer_icons" />
                        </a>
                        <a className="footer_icons_container" href="https://www.pinterest.se/globuzzer/">
                    ...
                    <div className="footer-content-icon-container">
                        ...
                        <a className="footer_icons_container" href="https://www.linkedin.com/company/globuzzer/">
                            <FaLinkedinIn className="footer_icons" />
                        </a>
                        <a className="footer_icons_container" href="https://www.instagram.com/globuzzer/">
    ...
    const FooterMobile = () => (
        <footer>
            ...
            <div className="footer-content">
                <div className="footer-content-column">
                    <a href={mapLink} target="_blank" rel="noopener noreferrer" style={{textAlign: "center"}}>
                        Backängsvägen 24 <br />
                        192 73 Sollentuna, Sweden
                    </a>
                    <a href="tel:+46 73 555 5 134">+46 73 555 5 134</a>
